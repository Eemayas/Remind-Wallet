...
import 'package:remind_wallet/Pages/edit_transaction.dart';
...
class _TranasctionDetailPageState extends State<TranasctionDetailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    db.getTransactionDB();
    final index = Database.TransactionList.indexWhere(
        (element) => element[transactionCreatedDateD] == widget.createdDate);
    print(index);
    return Scaffold(
          ...
          final result = await Navigator.push(
              ...
              MaterialPageRoute(
                  builder: (context) => EditTransaction(
                        transactionTitle: Database.TransactionList[index]
                            [transationNameD],
                        amount: Database.TransactionList[index]
                                [transactionAmountD]
                            .toString(),
                        transactionType: Database.TransactionList[index]
                            [transactionTypeD],
                        transactionTag: Database.TransactionList[index]
                            [transactionTagD],
                        transactionDate: Database.TransactionList[index]
                            [transactionDateD],
                        Account: Database.TransactionList[index]
                            [transactionAccountD],
                        transactionPerson: Database.TransactionList[index]
                            [transactionPersonD],
                        transactionNote: Database.TransactionList[index]
                            [transactionDescriptionD],
                        createdDate: Database.TransactionList[index]
          ...
          child: Column(
            ...
            children: [
              ...
              DetailField(
                ...
                title: 'Amount',
                data:
                    "RS ${Database.TransactionList[index][transactionAmountD]}",
